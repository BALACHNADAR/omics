<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/UserMasterPage.master" CodeFile="AddPatientBasicDetails.aspx.cs" Inherits="AddPatientBasicDetails" %>

<asp:Content ContentPlaceHolderID="usermaterpage" runat="server">

    <asp:Panel style="position: absolute; top: 237px; left: 164px; height: 390px; width: 963px;" 
        ...
        <asp:Label style="position: absolute; top: 19px; left: 238px" ID="Label1" 
            runat="server" Text="Enter Patient Records" Font-Bold="True" 
        ...
        <asp:ImageButton style="position: absolute; top: 337px; left: 333px; right: 520px;" 
