<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/ClientMasterPage.master" CodeFile="ClientSide4.aspx.cs" Inherits="ClientSide4" %>
...
<asp:Content ContentPlaceHolderID="usermaterpage" runat="server">
    ...
    <asp:Label Style="position: absolute; text-align: center; top: 266px; left: 204px; width: 768px;" ID="Label1"
        runat="server" Font-Size="Large" BackColor="#FF0066" BorderColor="#0066FF" BorderWidth="2px" ForeColor="Yellow" Font-Bold="True">Drug Treatment</asp:Label>

    <asp:Image style="position: absolute; top: 322px; left: 96px; height: 550px; width: 550px;" 
        ID="Image1" runat="server" ImageUrl="~/projectimages/drug treatment.jpg" BorderColor="#000066" BorderWidth="2px" BorderStyle="None" />
