<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/AdminMasterPage.master" CodeFile="IdentifyOmics2.aspx.cs" Inherits="IdentifyOmics2" %>
...
<asp:Label Style="position: absolute; text-align: center; top: 266px; left: 204px; width: 768px;" ID="Label1"
        runat="server" Font-Size="Large" BackColor="#FFFF66" BorderColor="#0066FF" BorderWidth="2px" ForeColor="Red" Font-Bold="True">Biomolecular   --&gt;  Drug Treatment</asp:Label>

    <asp:Image style="position: absolute; top: 338px; left: 226px; " 
        ID="Image1" runat="server" ImageUrl="~/projectimages/drugarchi1.jpg" BorderColor="#000066" BorderWidth="2px" />

    <asp:Panel Style="position: absolute; top: 318px; left: 710px; height: 381px; width: 419px;"
        ID="Panel1" runat="server" BackColor="#DCA944">
        <br />
        <br />
