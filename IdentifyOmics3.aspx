<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/AdminMasterPage.master" CodeFile="IdentifyOmics3.aspx.cs" Inherits="IdentifyOmics3" %>
...
<asp:Content ContentPlaceHolderID="usermaterpage" runat="server">
    ...
    <asp:Label Style="position: absolute; text-align: center; top: 266px; left: 204px; width: 768px;" ID="Label1"
        runat="server" Font-Size="Large" BackColor="#FF0066" BorderColor="#0066FF" BorderWidth="2px" ForeColor="Yellow" Font-Bold="True">Compare Bacteria or Virus etc..</asp:Label>

    <asp:Image style="position: absolute; top: 322px; left: 96px; height: 550px; width: 550px;" 
        ID="Image1" runat="server" ImageUrl="~/projectimages/BACKTERIAIMAGE.jpg" BorderColor="#000066" BorderWidth="2px" BorderStyle="None" />

    <asp:Panel Style="position: absolute; top: 318px; left: 710px; height: 381px; width: 419px;"
        ID="Panel1" runat="server" BackColor="#29AB96">
        <br />
        <br />
