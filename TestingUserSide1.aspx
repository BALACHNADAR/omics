<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/UserMasterPage.master" CodeFile="TestingUserSide1.aspx.cs" Inherits="TestingUserSide1" %>
...
<asp:Label Style="position: absolute; text-align: center; top: 266px; left: 204px; width: 768px;" ID="Label1"
    ...
    <asp:Panel Style="position: absolute; top: 318px; left: 203px; height: 381px; width: 919px;"
        ID="Panel1" runat="server" BackColor="#3B8EEE">
    ...
    <asp:ImageButton style="position: absolute; top: 434px; left: 1173px; right: 275px;" 
            ...
            ImageUrl="~/projectimages/starttest.png" onclick="ImageButton1_Click" BorderColor="Red" BorderWidth="2px" />
</asp:Content>
