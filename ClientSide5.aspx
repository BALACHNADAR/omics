<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/ClientMasterPage.master" CodeFile="ClientSide5.aspx.cs" Inherits="ClientSide5" %>
...
<asp:Label Style="position: absolute; text-align: center; vertical-align:middle; top: 243px; left: 266px; width: 472px; height: 54px;" ID="Label1"
        runat="server" Font-Size="XX-Large" BackColor="Yellow" BorderColor="#0066FF" BorderWidth="2px" ForeColor="Red" Font-Bold="True">IDENTIFY BIOMARKERS</asp:Label>

    <asp:Image style="position: absolute; top: 322px; left: 96px; height: 550px; width: 893px;" 
        ID="Image1" runat="server" ImageUrl="~/projectimages/biomarkerArchi.jpeg" BorderColor="#000066" BorderWidth="2px" BorderStyle="None" />
