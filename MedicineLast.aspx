<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/AdminMasterPage.master" CodeFile="MedicineLast.aspx.cs" Inherits="MedicineLast" %>
...
<asp:Label Style="position: absolute; text-align: center; vertical-align:middle; top: 243px; left: 266px; width: 472px; height: 54px;" ID="Label1"
        runat="server" Font-Size="XX-Large" BackColor="Black" BorderColor="#0066FF" BorderWidth="2px" ForeColor="Red" Font-Bold="True">MEDICINE TO PATIENT</asp:Label>

    <asp:Image style="position: absolute; top: 322px; left: 96px; height: 550px; width: 835px;" 
        ID="Image1" runat="server" ImageUrl="~/projectimages/medicine.png" BorderColor="#000066" BorderWidth="2px" BorderStyle="None" />

    <asp:Panel Style="position: absolute; top: 326px; left: 1023px; height: 381px; width: 419px;"
        ID="Panel1" runat="server" BackColor="#00CC00">
        <br />
        <br />
    ...
    <%--<asp:ImageButton style="position: absolute; top: 735px; left: 1020px; right: 123px; height: 136px;" 
            ...
            ImageUrl="~/projectimages/complete1.jfif" onclick="ImageButton1_Click" BorderColor="Red" BorderWidth="2px" BackColor="#CC0000" />--%>
</asp:Content>
